...
class SpringProfileServiceApplicationTest {
    ...
    void mainRunSuccessful() {
        try (MockedStatic<SpringApplication> mockedStatic = mockStatic(SpringApplication.class)) {
            ...
            SpringProfileServiceApplication.main(new String[]{});

            mockedStatic.verify(() -> SpringApplication.run(SpringProfileServiceApplication.class, new String[]{}));
        }
    }
}
