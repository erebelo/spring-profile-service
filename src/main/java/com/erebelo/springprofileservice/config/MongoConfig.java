...
import com.erebelo.springprofileservice.config.converter.LocalDateReadingConverter;
import com.erebelo.springprofileservice.config.converter.LocalDateWritingConverter;
...
@Configuration
@EnableMongoAuditing
@EnableMongoRepositories(basePackages = "com.erebelo.springprofileservice")
